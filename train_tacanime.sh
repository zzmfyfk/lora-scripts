...
train_data_dir="./train/tac_anime"              # train dataset path | 训练数据集路径
...
save_every_n_epochs=5 # sa2ve every n epochs | 每 N 个 epoch 保存一次
...
output_name="tac_anime"           # output model name | 模型保存名称
...
sample_prompts="./train/tac001/1.txt"
...
max_bucket_reso=1526             # arb max resolution | arb 最大分辨率
